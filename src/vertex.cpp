...
{
	for(int i = 0; i < nrOfIndicies; i+=3)
	{
		// Shortcuts for vertices
		glm::vec3 & v0 = verticesIn[indices[i+0]].Position;
		glm::vec3 & v1 = verticesIn[indices[i+1]].Position;
		glm::vec3 & v2 = verticesIn[indices[i+2]].Position;

		// Shortcuts for UVs
		glm::vec2 & uv0 = verticesIn[indices[i+0]].TexCoords;
		glm::vec2 & uv1 = verticesIn[indices[i+1]].TexCoords;
		glm::vec2 & uv2 = verticesIn[indices[i+2]].TexCoords;
		...
		verticesIn[indices[i+0]].Tangent = tangent;
		verticesIn[indices[i+1]].Tangent = tangent;
		verticesIn[indices[i+2]].Tangent = tangent;

		verticesIn[indices[i+0]].Bitangent = bitangent;
		verticesIn[indices[i+1]].Bitangent = bitangent;
		verticesIn[indices[i+2]].Bitangent = bitangent;
	}
}
