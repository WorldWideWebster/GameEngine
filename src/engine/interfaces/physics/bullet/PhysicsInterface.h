...
struct PhysicsInterfaceOptions
{
	...
	PhysicsInterfaceOptions(struct GUIHelperInterface* helper, int option = 0)
		: m_guiHelper(helper),
		  m_option(option),
		  m_fileName(0),
		  m_sharedMem(0),
...
{
public:
	typedef class PhysicsInterface*(CreateFunc)(PhysicsInterfaceOptions& options);
...
public:
	...
	virtual PhysicsInterface::CreateFunc* getExampleCreateFunc(int index) = 0;
...
PhysicsInterface* StandaloneExampleCreateFunc(PhysicsInterfaceOptions& options);
